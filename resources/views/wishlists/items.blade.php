...
<div class="wishlist-section">
    <h2>Items <a href="{{ route('wishlists.add.items') }}" class="btn-add">Add to wishlist</a></h2>
...
<p style="margin-top: 1rem; font-size: 0.875rem; color: var(--text-secondary);">Share: <input type="text" readonly value="{{ $shareItemsUrl }}" id="share-url" style="width: 18rem; max-width: 100%; padding: 0.3rem 0.5rem; font-size: 0.8125rem; border: 1px solid var(--border); border-radius: var(--radius-sm); background: var(--bg);"> <button type="button" class="btn-copy-wishlist" data-copy="share-url" style="padding: 0.3rem 0.5rem; font-size: 0.8125rem;">Copy</button></p>
