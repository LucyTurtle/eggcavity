        ...
        <div class="form-group">
            ...
            <select name="archive_item_id" id="archive_item_id" required>
                ...
                @foreach($creatures as $creature)
                    <option value="{{ $creature->id }}" {{ old('archive_item_id') == $creature->id ? 'selected' : '' }}>{{ $creature->title }}</option>
                @endforeach
            </select>
        ...
        <div class="form-group">
            ...
            <select name="item_id" id="item_id" required>
                ...
                @foreach($travels as $travel)
                    <option value="{{ $travel->id }}" {{ old('item_id') == $travel->id ? 'selected' : '' }}>{{ $travel->name }}</option>
                @endforeach
            </select>
